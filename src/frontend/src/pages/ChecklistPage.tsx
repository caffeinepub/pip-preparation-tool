    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Follow these steps to prepare and submit your PIP claim. Tick each
          step as you complete it — your progress is saved automatically.
        </p>
      </div>

      {/* Progress Bar */}
      <section className="section-card mb-8" aria-label="Checklist progress">
          ...
          return (
            ...
            >
              ...
              <div className="flex-shrink-0 hidden sm:block">
                <div
                  className={`w-9 h-9 rounded-full flex items-center justify-center ${isChecked ? "bg-success/20" : "bg-muted"}`}
                >
                  <Icon
                    className={`w-4 h-4 ${isChecked ? "text-success" : "text-muted-foreground"}`}
                    aria-hidden="true"
                  />
                </div>
              </div>
