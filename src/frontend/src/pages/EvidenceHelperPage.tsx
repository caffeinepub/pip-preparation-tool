...
const evidenceItems = [
  ...
  },
  {
    ...
    description:
      "Any letters from hospital consultants, specialists, or outpatient clinics.",
  },
  {
    id: "diagnosis-letters",
    label: "Diagnosis letters",
    description:
      "Letters confirming your diagnosis from a doctor or specialist.",
  },
  {
    id: "care-plan",
    label: "Care plan or support plan",
    description:
      "Any formal care plan from social services, a care coordinator, or similar.",
  },
  {
    id: "bad-day-diary",
    label: 'Diary of a "bad day"',
    description:
      "A written account of what a typical bad day looks like for you — what you can and cannot do.",
  },
  {
    id: "support-worker",
    label: "Support worker or carer statement",
    description:
      "A written statement from anyone who helps you with daily tasks.",
  },
  {
    id: "therapy-records",
    label: "Therapy or treatment records",
    description:
      "Records from physiotherapy, occupational therapy, mental health services, etc.",
  },
];

export function EvidenceHelperPage() {
  const [evidenceChecked, setEvidenceChecked] = useLocalStorage<
  ...
  const gatheredCount = evidenceItems.filter(
    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Strong evidence significantly improves your chances of a successful
          PIP claim. Use this page to track what evidence you have gathered and
          keep a list of your documents.
        </p>
      </div>
      ...
      <section aria-labelledby="evidence-checklist-heading" className="mb-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge
            variant={
              gatheredCount === evidenceItems.length ? "default" : "secondary"
            }
          >
          ...
          {evidenceItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <p
                    className={`font-medium text-sm ${isChecked ? "line-through text-muted-foreground" : "text-foreground"}`}
                  >
                    {item.label}
                  </p>
      ...
      <section aria-labelledby="document-list-heading">
        ...
        <p className="text-sm text-muted-foreground mb-5">
          Keep a record of the documents you have gathered. Enter the document
          name and date (e.g., date of the letter). No files are uploaded — this
          is a reference list only.
        </p>
          ...
          <div className="mt-4 pt-4 border-t border-border">
            <button
              ...
              onClick={() => {
                if (
                  window.confirm(
                    "Are you sure you want to clear all documents from your list?",
                  )
                ) {
                  setDocuments([]);
                }
