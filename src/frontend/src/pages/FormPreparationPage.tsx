...
export function FormPreparationPage() {
  ...
  const progressPercent = Math.round(
    (answeredCount / pipActivities.length) * 100,
  );
    ...
    >
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Draft your answers to each activity area below. Your answers are saved
          automatically as you type. Use the tips to help you describe how your
          condition affects you on your worst days.
        </p>
      </div>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          ...
          <Badge
            variant={
              answeredCount === pipActivities.length ? "default" : "secondary"
            }
          >
        ...
        <Progress
          ...
          className="h-2"
          aria-label={`${progressPercent}% of form sections drafted`}
        />
      ...
      {/* Activity Sections */}
      <ul className="space-y-3" aria-label="PIP2 activity areas">
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <ul
                      ...
                      aria-label={`Tips for ${activity.title}`}
                    >
                      {activity.tips.map((tip) => (
                        <li key={tip} className="tip-item">
                          <span className="text-primary font-bold text-xs flex-shrink-0 mt-0.5">
                            →
                          </span>
      ...
      <div className="mt-8 pt-6 border-t border-border">
        <button
          ...
          onClick={() => {
            if (
              window.confirm(
                "Are you sure you want to clear all your drafted answers? This cannot be undone.",
              )
            ) {
              setAnswers({});
            }
