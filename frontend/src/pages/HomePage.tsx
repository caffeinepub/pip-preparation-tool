...
import { AlertTriangle, CheckCircle, ArrowRight, Phone, FileText, ClipboardList, BookOpen } from 'lucide-react';
...
const features = [
    {
        ...
        description: 'Track your progress through the PIP claim process with a clear, ordered checklist.',
        to: '/checklist',
    },
    {
        icon: FileText,
        title: 'Form Preparation',
        description: 'Draft your answers to all 12 PIP2 activity areas with plain-English guidance and tips.',
        to: '/form-preparation',
    },
    {
        icon: CheckCircle,
        title: 'Evidence Helper',
        description: 'Know exactly what evidence to gather and keep track of your documents.',
        to: '/evidence-helper',
    },
    {
        icon: BookOpen,
        title: 'Assessment Guide',
        description: 'Understand what to expect at your assessment and how to prepare effectively.',
        to: '/assessment-guide',
    },
];
...
export function HomePage() {
    return (
        <main id="main-content" className="flex-1">
            ...
            <section className="max-w-6xl mx-auto px-4 sm:px-6 py-6" aria-label="Important disclaimer">
                <Alert className="border-warning/50 bg-warning/10">
                    ...
                    <AlertDescription className="text-warning-foreground/90 mt-1 leading-relaxed">
                        <strong>This tool is for preparation only.</strong> It is not affiliated with the UK government or the Department for Work and Pensions (DWP). This app does not submit your claim or guarantee an award.{' '}
                        <strong>To start your PIP claim, you must call the DWP on{' '}
                            <a
                        ...
                        </strong>. Lines are open Monday to Friday, 8am to 6pm.
                    </AlertDescription>
                </Alert>
            </section>

            {/* How to Start Your Claim */}
            <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-8" aria-labelledby="how-to-start">
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <div>
                        <h2 id="how-to-start" className="font-semibold text-foreground text-base mb-1">
                            Step 1: Call the DWP to Start Your Claim
                        </h2>
                        <p className="text-muted-foreground text-sm leading-relaxed">
                            Before using this tool, you need to call the DWP on{' '}
                            <a href="tel:08009172222" className="text-primary font-semibold underline hover:no-underline">
                                0800 917 2222
                            </a>{' '}
                            to request the PIP2 form. This tool will then help you prepare your answers before you complete and return the form.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {/* Features Grid */}
            <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-12" aria-labelledby="features-heading">
                <h2 id="features-heading" className="font-heading text-2xl font-bold text-foreground mb-2">
                    What This Tool Helps You Do
                </h2>
                <p className="text-muted-foreground mb-6">
                    Everything you need to prepare a thorough, well-evidenced PIP claim — all in one place.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {features.map((feature) => {
                        const Icon = feature.icon;
                        return (
                            <Card key={feature.to} className="hover:shadow-card transition-shadow group">
            ...
            {/* Privacy Assurance */}
            <section className="bg-secondary/50 border-t border-border" aria-labelledby="privacy-assurance">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
                    <div className="flex flex-col sm:flex-row items-start gap-4">
                        ...
                        <div>
                            <h2 id="privacy-assurance" className="font-semibold text-foreground text-lg mb-2">
                                Your Data Stays on Your Device
                            </h2>
                            <p className="text-muted-foreground text-sm leading-relaxed max-w-2xl">
                                This tool does not require an account or login. All your answers, checklist progress, and document notes are saved only in your browser's local storage — they never leave your device and are never sent to any server. You can clear your data at any time.{' '}
